...
/*! \brief Load given resource type to given program instance.
    ...
    \param out If set, result of load operation will be returned.
...
enum PINST_TEXTFLAG
{
    ...
    PINST_TEXTFLAG_HALIGN_LEFT = 0x00,
    PINST_TEXTFLAG_HALIGN_CENTER = 0x01,
    PINST_TEXTFLAG_HALIGN_RIGHT = 0x02,
    PINST_TEXTFLAG_VALIGN_UP = 0x00,
    PINST_TEXTFLAG_VALIGN_CENTER = 0x04,
    PINST_TEXTFLAG_VALIGN_DOWN = 0x08,
};
